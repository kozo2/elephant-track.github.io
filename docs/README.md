...
Download and extract the latest release of the ELEPHANT server [here](https://github.com/elephant-track/elephant-server/archive/releases/latest/v0.5.6.zip).
...
Download and extract the latest release of the ELEPHANT server [here](https://github.com/elephant-track/elephant-server/archive/refs/tags/v0.5.6.zip).
